            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Row(
                        children: [
                          ...
                          CategoryCard(
                            image: Image.asset(
                              Helper.getAssetName("food2.jpg", "real"),
                              fit: BoxFit.cover,
                            ),
                            name: "Ikan Bakar",
                          ),
                          ...
                          CategoryCard(
                            image: Image.asset(
                              Helper.getAssetName("food3.jpg", "real"),
                              fit: BoxFit.cover,
                            ),
                            name: "Nasi Goreng",
                          ),
                  ...
                  RestaurantCard(
                    image: Image.asset(
                      Helper.getAssetName("chicken.jpg", "real"),
                      fit: BoxFit.cover,
                    ),
                    name: "Bumi Aki",
                  ),
                  RestaurantCard(
                    image: Image.asset(
                      Helper.getAssetName("spagheti.jpg", "real"),
                      fit: BoxFit.cover,
                    ),
                    name: "Spagheti Karibiru",
                  ),
                  SizedBox(
                    height: 20,
                  ),
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        TextButton(
                          onPressed: () {
                            Navigator.of(context).pop(viewAll.routeName);
                          },
                          child: Text("View all"),
                        ),
                      ],
                      ...
                      child: Row(
                        children: [
                          ...
                          MostPopularCard(
                            name: "Steik Abuba",
                            image: Image.asset(
                              Helper.getAssetName("steik.jpg", "real"),
                              fit: BoxFit.cover,
                            ),
                          )
                        ],
